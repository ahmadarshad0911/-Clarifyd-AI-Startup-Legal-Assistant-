...
const FAQS: Faq[] = [
  ...
  { id: "sec",     category: "security",  q: "How is my data secured?", a: "AES-256 at rest, TLS 1.3 in transit. Every reasoning call, login, and export appends to a hash-chained audit log — tamper-evident by default." },
